        ...
        function openEditModal(type, item) {
            ...
            if (type === 'member') {
                ...
                fieldsContainer.innerHTML = `
                    ...
                    <div><label class="text-xs text-gray-400">Doc Type</label><select name="doc_type" class="w-full mt-1 p-2.5 bg-gray-800 rounded-xl border border-gray-700 text-sm"><option value="Aadhaar Card" ${item.doc_type=='Aadhaar Card'?'selected':''}>Aadhaar Card</option><option value="PAN Card" ${item.doc_type=='PAN Card'?'selected':''}>PAN Card</option><option value="Voter ID" ${item.value=='Voter ID'?'selected':''}>Voter ID</option><option value="Driving License" ${item.doc_type=='Driving License'?'selected':''}>Driving License</option><option value="Passport" ${item.doc_type=='Passport'?'selected':''}>Passport</option></select></div>
